{
  "service": "ij-mailjet",
  "description": "Сервис отправки писем через Mailjet, который позволяет пользователям легко отправлять электронные письма с различным содержанием и настройками SMTP.",
  "endpoints": [
    {
      "method": "POST",
      "url": "/api/send-mail",
